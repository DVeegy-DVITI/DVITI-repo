...
{
    internal class StrategyGetLocalNumber : IBusinessRuleEvaluationStrategy<string, string>
    {
        // [Delegate Signatures]
        ...
        {
            return _target.Substring(_target.Length-4, 4);
        }
